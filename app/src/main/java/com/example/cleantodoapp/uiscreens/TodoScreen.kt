package com.example.cleantodoapp.uiscreens
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(
                    ...
                    var isEditing by remember(key1 = todo.id) {
                        mutableStateOf(false)
                    }
                    var newTitle by remember(key1 = todo.id) {
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            Checkbox(
                                checked = todo.isDone,
                                onCheckedChange = {
                                    todoViewModel.toggleTodoDone(todo)
                                },
